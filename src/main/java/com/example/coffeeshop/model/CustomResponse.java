...
public class CustomResponse<T extends Object> {
	...
	public CustomResponse(List<T> payload, List<CustomError> errors, boolean isSuccess, String timeStamp) {
		super();
	...
	public String toString() {
		return "CustomResponse [payload=" + payload + ", errors=" + errors + ", isSuccess=" + isSuccess + ", timeStamp="
				+ timeStamp + "]";
	}
